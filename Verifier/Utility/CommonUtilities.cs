...
namespace Utils
{
    ...
    {
        public static Int32 ConvetToInt(String text)
        {
            ...
            {
                //log.ErrorFormat("Can NOT Convert {0} To Integer.", text);
                throw new UserInterfaceException(99901, "خطای 99901: فرمت متن ورودی صحیح نمی باشد.");
            }
        }
